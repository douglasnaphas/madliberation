...
These are the reasonable-but-not-necessarily intuitive laws, like {{ an obscure, but reasonable Biblical law // thou shalt milk the cow at the crack of dawn // ___ // honor thy neighbor's garbage }}. These also encompass laws commanding you to celebrate Shabbat, Festivals, and Important Rites of Passage, such as {{ a rite of passage // learning to ride a bike //  // the first time eating solid food }}.
...
Wicked child, you are not part of the tribe. We would all make {{ something not solid // gelatin // ___ is not solid // soup }} of your {{ body parts // organs // he has __ // bones }} if we could. We already regret inviting you, for you are the worst of all children. You are worse than {{ a villain // Darth Vader // ___ is a horrible character // Haman }}, but still, we are blessed you are here.  
