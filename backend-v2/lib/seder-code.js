 ...
 * pre: res.locals.{path,leaderEmail,pw} are populated with strings
 * post:
 ...
 *   - path, leaderEmail, and pw from res.locals are saved in the db with PK equal to the Seder Code and SK equal to schema.SEDER_PREFIX
 * 500 on error
