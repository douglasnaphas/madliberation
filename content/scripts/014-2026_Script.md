...
{{ A brief salutation // Hi! //  // Oh, hey. }}. This is the moment we’ve been waiting for, and the moment we re-live year after year. This is {{ a highly anticipated event // My wedding day // // the Superbowl }}. This is {{ an event of great importance to the world // the discovery of gravity // // the Copernican Revolution }}. This is Passover.
...
5. Tell the story of my good sis Moses, from the perspective of {{ a minor character in Exodus (make one up if you don’t know) // Jethro, the priest of Midian // // the Egyptian who Moses kills }}
...
Let us take a moment to quietly celebrate our liberation.

[[ Stage direction: Everyone take a moment to silently contemplate your freedom. ]]

Thank you for thinking with me. And now, finally, to eat! Just kidding, haha. No, next we're going to reflect even more about why we're here tonight.
...
I know these are tough questions, so we’d better all sing them together, in Hebrew, so all you ancient relics can understand.
...
Why do we {{ something we do on Passover // drink four glasses of wine // This Passover, we are going to _. // talk for so long before we eat }}?
...
To answer your second question seriously, we have many responsibilities, now that we are powerful.

Here is but one. We must {{ a responsibility of the powerful to the powerless // give alms // It is incumbent upon us to __ // follow a written use of force policy }}, for in this way we honor the powerless.

Here is but another. We must {{ a responsibility of the powerful to each other // remind one another of our obligations to God // We must __ // keep secrets }}, for in this way to we honor each other.

To answer your first question flippantly, God commands us to {{ take an action // create a file // I am going to __ // lift the puppy }} BEFORE we {{ take an action // make a cake // I am going to __ // screw the pooch }}. This means that one may not EVER {{ take an action // sing // I am going to ___. // leave the chamber }} AFTER {{ an event // the shrew parade // I attended ___. // the taming of the shrew }}. Now, this is all nonsense. But fortunately there are three categories of sub-laws to clarify God’s position. They are:
...
I don’t care about you or any of my so-called people! All I wanna do is {{ take a selfish action // sell stocks // I am going to ___ // hunt pandas }}, and eat {{ something edible // buttercream // he will eat___ // nutter butters }} in my {{ an article of clothing that you own // hat // check out my __ // socks }}.
...
Twenty years later, Moses questioned his identity. He noticed a tingling sensation every time he {{ very Jewish thing to do (past tense) // braided challah for the oneg // He __. // pressured his daughter to apply to the Albert Einstein College of Medicine }}, and a rush of joy whenever he {{ did something a few times in the past that was very Jewish // caught a whiff of whitefish // He often __. // heard the opening notes of "Rhapsody in Blue" }}. He realized that he was Jewish.
...
After all his victim’s family members died, Moses saw {{ an item that should NOT be on fire // a house // That is _, and it is on fire, so I’m upset. // a MacBook Pro }} on fire. It spoke:
...
Moses moseyed into Pharaoh’s hall and introduced the coming plagues. “{{ A polite way of telling people you're about to turn the river into blood // Sir, I apologize, but I am about to turn your river gently into blood //  // Drink blood, my good sir }}”.

And then there was blood.

Pharoah didn't like receiving complaints of his people having to {{ do something people normally do with water // bathe //  // take their probiotics }} with blood or cook their {{ something you cook in water // couscous //  // kidney beans }} with it.

But he still had water, because of inequality. Moreover, changing the river into blood was a well-known Egyptian parlor trick, performed at birthday parties, like {{ a parlor trick // yanking a tablecloth out from under dishes  //  // turning your tongue upside-down }}. So Pharaoh went back to {{ doing a leisure activity // reclining on plush couches // // playing golf with his attorney }}, and the Jews remained enslaved.

### # {{ Page }}

#### Plague Combo One: Frogs (tzfardeiya) and Lice (kinim)

So spake Moses, “{{ An ominous statement // Prepare for the worst //  // To thee, this day, I send a thousand travails }}”.
...
The beasts were persuasive. They {{ took a destructive action // threw a brick through a window //  // damaged the school }}. They {{ took an offensive action // slept through the Pledge of Allegiance // They _, and it was offensive // put their feet on the desk }}. They went into {{ local businesses // pharmacies // // WaWas }} and used the restrooms without purchasing anything.

The beasts {{ did something wild animals shouldn’t be doing to/with cattle // wrestled // The wild beasts _ the cattle.  // snuggled }} the cattle of Egypt. This gave all the cattle {{ a terrible infectious disease // lassa fever // They got infected with _.  // tetanus}}.

With their big, feverish eyes and {{ cute characteristic // smooth fur // Those animals are cute, because they have _.  // high-pitched whining }}, the diseased cattle were so cute, that the children couldn’t help but {{ do an activity that you do with a pet // play fetch with // I am going to _ my dog. // cuddle }} them. And then the children all erupted in boils, as the cattle disease had jumped species.
...
“{{ a consoling phrase // It gets better //  // I’m sorry for your loss }},” said Pharoah as he left the palace, enslaving Jews.
...
“{{ Something you say when you’re upset // Gosh darn it // // Woe is me }}!” cried the children, who were naked.

Safe in his palace, Pharaoh asked, “How’s the weather today, {{ derisive term for people (plural) // fools //  // punks }}?”

“All hail, Pharaoh,” the Egyptians replied.

“All hail me, indeed,” said Pharaoh, and went back to {{ doing a leisure activity for noblemen // pheasant hunting // Members of the nobility spent their time _. // donating money to elite universities }}, without freeing the Jews.
...
God decided to personally go door to door, and kill the first-born in each family with {{ a weapon // nunchucks  // I have __ // an axe }}. The first child was killed sitting in darkness gnawing a frog skeleton, scratching his lice bites. “I’ve had a good life,” he said.

The Jews were exempt. All they had to do to protect themselves was {{ something you do to protect yourself // wear sunscreen // Make sure you _, to protect yourself // buy homeowner’s insurance  }}, and all Jewish first-borns were spared. That’s why we call it “Passover.”
...
It wasn’t a man that said it. It was a woman. And she said something different. She said, “I’m adding an orange to my seder plate as a symbol of the fruitfulness for all Jews when lesbians and gay men are contributing and active members of Jewish life.” So this orange represents {{ a gay person you like // Leonardo da Vinci // // Pete Buttigieg}}.
...
Remember those who are missing, or oppressed, or both! Remember {{ someone missing from the Seder // Great Grandma X // // Paul }}!
...
Think of the humble walnut. Think of it in a pile. As the midrash teaches, “If you take one walnut from a heap, all of the other walnuts fall down and roll after one another. So, too, if one Jew is stricken, all of us feel pain.” And we also kinda roll with it.
...
## Climax | shulchan oreich

As is tradition, we will now go around the room and answer the following question:

{{ a question from group therapy // What is the source of your anger? // // Have your cousins ever made you uncomfortable? }}

JUST KIDDING.

No, instead we will now go around the room and eat dinner, one a time.

JUST KIDDING.

No, no, holy children, now we will eat the whole meal. The holy meal. If we come back to the table afterwards, we'll go to the next page.

[[ Pause the Haggadah reading and eat dinner. ]]
...
Elijah can not only open doors, he can finish meals, and {{ do something ghosts do // walk through walls // I'm a ghost, so I guess I'll __ // hold you accountable }}. He’s here right now. Pour him a drink and tell him how you really feel. Repeat after me. 
...
## Closing rites: the FOURTH glass of wine
