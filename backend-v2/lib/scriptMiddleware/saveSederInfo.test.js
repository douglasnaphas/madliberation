...
describe("scriptMiddleware/saveSederInfo", () => {
  ...
  test("several participants, not all assignments answered, answers out of order", () => {
    const expectedVersion = "lhMEdJDP1ItMXPIb2nnnMMnDRCtUL3.Daa";
    const expectedPath = "madliberation-scripts/007-2019_Script";
    const dbData = {
      Items: [
  ...
  test("several participants, not all assignments answered, answers out of order, answers in answers_map", () => {
    const expectedVersion = "lhMEdJDP1ItMXPIb2nnnMMnDRCtUL3.Daa";
    const expectedPath = "madliberation-scripts/007-2019_Script";
    const dbData = {
      Items: [
  ...
  test("several participants, not all assignments answered, answers out of order, answers in answers_map, bad map keys", () => {
    const expectedVersion = "lhMEdJDP1ItMXPIb2nnnMMnDRCtUL3.Daa";
    const expectedPath = "madliberation-scripts/007-2019_Script";
    const dbData = {
      Items: [
