...
As everyone knows, Passover is really all about {{ the meaning of Passover // remembering our people's epic journey from slavery and oppression to freedom // // libations and liberation }}. Yes, there are many ways in which we, and others, could still be more free. But for now, let us focus on our freedoms. Let us appreciate, celebrate, and {{ verb ending in -ate // palpate // // masticate }} our exodus from the Narrow Places of Mitzraim to the Land of {{ two things that go well together // Peanut Butter and Jelly // // Coffee and Cigarettes }}.
