...
beforeEach(() => {
  process.env.WS_ENDPOINT =
    "100abc.execute-api.us-east-1.amazonaws.com/ws-read-roster";
});
afterEach(() => {
  jest.resetAllMocks();
  jest.resetModules();
  ...
  test.each([
    // happy path 1: 1 Record, 1 participant connection
    {
        ...
        Records: [
          {
            ...
            dynamodb: {
              ...
              NewImage: {
                ...
                answers: { L: [{ answer: "this was an answer", id: 4 }] },
                lib_id: {
                  S: "participant#a2fbc754b9ee1dc5a793eeb2c804c5e6cf962f680909050f28a69b6cdfdbab89",
                },
                room_code: {
      ...
      queryData: {
        Items: [
          {
            lib_id: "connect#read-roster#Le#PvsmLdr_IAMCJyB=",
            room_code: "HGKYIQ",
    ...
    // happy path 2: 1 Record, 1 participant connection",
    {
      ...
      queryData: {
        Items: [
          {
            lib_id: "connect#read-roster#Me Sir#PbbmLdr_IAMCJyB=",
            room_code: "BBKYIQ",
    ...
    // multiple Records, multiple connections, failed posts
    {
      ...
      queryData: [
        ...
        },
        {
          Items: [
            {
              lib_id: "connect#read-roster#Me3Sir#PccmLdr_IAMCJyB=",
              room_code: "CCKYIQ",
              date: "2022-03-27T03:56:04.897Z",
            ...
            {
              lib_id: "connect#read-roster#Me3Sir#PcdmLdr_IAMCJyB=",
              room_code: "CCKYIQ",
    ...
    async ({
      ...
      const handler = require("./submit").handler;
